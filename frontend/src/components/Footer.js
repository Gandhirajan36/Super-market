  ...
  return (
    <Box>
      ...
      <Container>
        <Row>
          ...
          <Column>
            ...
            <FooterLink href="#">DINDIGUL</FooterLink>
            <FooterLink href="#">MADURAI</FooterLink>
            <FooterLink href="#">THIRUPUR</FooterLink>
          </Column>
          <Column>
      ...
      <div className="footer-copyright text-center py-3" h1 style={{ color: "#9d9cff"}}>
        <Container fluid>
           Copyright 2022 © SM Supermarket. All Rights Reserved.
        </Container>
      </div>
    </Box>
  );
